...
export async function linkCoverage(items, { deepseek, today }) {
...
export async function writeScript(docs, sphere, { deepseek, today, delivery = '' }) {
  if (!docs.length) {
    return (
  ...
  return deepseek([
    {
      role: 'system',
      content:
        'You write a spoken Swedish briefing segment.\n' +
